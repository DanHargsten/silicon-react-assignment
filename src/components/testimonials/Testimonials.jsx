    ...
    <section className="testimonials">
      <div className="container">
        ...
        <figure className="testimonials__card">
          <img className="testimonials__quote" src="/images/icons/quotation-mark.svg" alt="" />
          <img className="testimonials__rating" src="/images/ratings/star-empty.svg" alt="Rated 4 out of 5 stars by Fannie Summers." />
          ...
          <figcaption className="testimonials__user-info">
            <img className="testimonials__user-photo" src="/images/avatars/portrait-fannie.svg" alt="Portrait of Fannie Summers." />
        ...
        <figure className="testimonials__card">
          <img className="testimonials__quote" src="/images/icons/quotation-mark.svg" alt="" />
          <img className="testimonials__rating" src="/images/ratings/star-filled.svg" alt="Rated 5 out of 5 stars by Albert Flores." />
          <blockquote className="testimonials__text">
          ...
          <figcaption className="testimonials__user-info">
            <img className="testimonials__user-photo" src="/images/avatars/portrait-albert.svg" alt="Portrait of Albert Flores." />
            <div className="testimonials__user-text">
